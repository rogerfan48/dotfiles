    ...
    mason_lspconfig.setup_handlers({
      ...
      ["jsonls"] = function()
        lspconfig.jsonls.setup({
          ...
          settings = {
            json = {
              schemas = require("schemastore").json.schemas(), -- 使用 schemastore 提供的 JSON Schema
              validate = { enable = true }, -- 啟用 JSON Schema 驗證
            },
          },
          init_options = {
            provideFormatter = false, -- 禁用 jsonls 內建的格式化功能，因為我們使用 Prettier
          },
        })
      end,
    })
